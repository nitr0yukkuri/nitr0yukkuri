...
/* 背景にQiitaの斜めグラデーションを敷く */
.js-calendar-graph {
  background: linear-gradient(45deg, #B67B03 0%, #DAAF08 45%, #FEE9A0 70%, #DAAF08 85%, #B67B03 90% 100%) !important;
}

/* 草を透明にして下のグラデーションを透かせる */
:root {
  --color-calendar-graph-day-bg: #161b22 !important; /* 草なしは背景色で隠す */
  --color-calendar-graph-day-L1-bg: rgba(22, 27, 34, 0.7) !important; /* 少し透ける */
  --color-calendar-graph-day-L2-bg: rgba(22, 27, 34, 0.4) !important;
  --color-calendar-graph-day-L3-bg: rgba(22, 27, 34, 0.1) !important;
  --color-calendar-graph-day-L4-bg: transparent !important; /* L4で完全にグラデーションが輝く */
}
